...
**Repo gate on `main`:** `pnpm exec tsc -b` exit 0 · `pnpm test` (`vitest run`, repo root) **1,109 tests / 184 files green**, plus **3,186** app tests across the nine apps, which the root suite does not run and CI does.
