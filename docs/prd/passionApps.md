...
**Repo gate on `main`:** `pnpm exec tsc -b` exit 0 · `pnpm test` (`vitest run`, repo root) **1,088 tests / 182 files green**, plus **2,880** app tests across the nine apps, which the root suite does not run and CI does.
