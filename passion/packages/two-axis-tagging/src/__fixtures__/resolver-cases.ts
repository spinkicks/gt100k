...
const mixingDesk: Artifact = {
  id: "mixer-01",
  domainPath: ["music-sound", "audio-systems"],
  affordedModes: ["debug", "investigate", "explain"],
  kind: "gadget",
  source: "gold",
  origin: "seed",
  tagConfidence: 1,
