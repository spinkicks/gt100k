...
export const WORK_MODE_DEFS: Record<WorkMode, WorkModeDef> = {
  build: {
    id: "build",
    gloss: "Produces a new artifact or structure.",
    produces: "artifact",
  ...
  investigate: {
    id: "investigate",
    gloss: "Probes how something works; need not produce an artifact.",
  ...
  compose: {
    id: "compose",
    gloss: "Creates an expressive work (music, art, writing).",
    produces: "artifact",
  ...
  perform: {
    id: "perform",
    gloss: "Executes/plays a skill live.",
  ...
  debug: {
    id: "debug",
    gloss: "Diagnoses and fixes a defect.",
    produces: "artifact",
  ...
  explain: {
    id: "explain",
    gloss: "Articulates understanding to others.",
    produces: "understanding",
  ...
  persuade: {
    id: "persuade",
    gloss: "Moves an audience toward a view or action.",
    produces: "understanding",
  ...
  collaborate: {
    id: "collaborate",
    gloss: "Works jointly with others toward a shared goal.",
    produces: "none",
  ...
  care: {
    id: "care",
    gloss: "Tends, maintains, or nurtures something over time.",
    produces: "none",
