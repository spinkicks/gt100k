...
import { COVERAGE_MIN_DOMAINS, GAMIFICATION_KEYS, SCALAR_KEYS } from "@gt100k/guardrails";
...
describe("@gt100k/guardrails golden constants (spec §3.4)", () => {
  ...
  it("GAMIFICATION_KEYS are the banned gamification field names (GC6)", () => {
    expect(GAMIFICATION_KEYS).toEqual(["streak", "points", "reward", "xp", "badge", "leaderboard"]);
  });
