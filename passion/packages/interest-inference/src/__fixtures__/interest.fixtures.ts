...
export const GOLDEN_EVENTS: CellEvent[] = [
  ...
  { domainPath: ["music-sound", "audio-systems"], mode: "build", kind: "cross_day_return", novelty: false, timestamp: D(4) },
  ...
  { domainPath: ["music-sound", "audio-systems"], mode: "build", kind: "failure_recovery", novelty: false, timestamp: D(5) },
  { domainPath: ["music-sound", "audio-systems"], mode: "build", kind: "cross_day_return", novelty: false, timestamp: D(6) },
