 ...
 *  contributes zero bytes to dist. Trace & Repair is silent — there is no gesture to make first.
 *
...
const LABELS = ["0 — five lines", "1 — seven lines, with pauses", "2 — nine lines"];
