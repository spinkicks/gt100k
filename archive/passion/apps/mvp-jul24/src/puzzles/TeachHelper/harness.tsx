 ...
 *  contributes zero bytes to dist. Teach the Helper is silent — there is no gesture to make first.
 *
...
const LABELS = ["0 — two parcels showing", "1 — three showing", "2 — hidden floors are sparser"];
