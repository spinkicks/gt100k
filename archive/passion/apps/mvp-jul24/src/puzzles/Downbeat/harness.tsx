 ...
 *  contributes zero bytes to dist. Press "Play the loop" first — browsers suspend an AudioContext
 *  created without a gesture.
 */
...
const LABELS = ["0 — easiest: obvious accents", "1 — quieter, may start mid-bar", "2 — hardest"];
