 ...
 *
 *  Sound needs a click first — browsers suspend an AudioContext created without a gesture — so press
 *  "Hear the note", not Reload.
 */
...
const LABELS = ["0 — easiest: tonic and fifth", "1 — adds the odd degrees", "2 — hardest"];
